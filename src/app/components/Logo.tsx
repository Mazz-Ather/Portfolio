...
const Logo = () => {
  ...
  <div className="absolute mx-8  top-0 left-0 bg-gradient-to-r from-blue-800 contrast-200 to-teal-800 text-white flex items-center justify-center rounded-full w-16 h-16 shadow-lg transform hover:scale-110 hover:rotate-12 transition-all duration-300 ease-out">
    <Link
      href="/"
