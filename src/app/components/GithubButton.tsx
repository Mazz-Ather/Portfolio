...
const GithubButton = ({ link, platform }: { link: string; platform: string }) => {
  ...
  return (
    <div className="flex justify-center mt-5">
      <a
        ...
        className="absolute ml-auto inline-block w-36 h-[2.7em] mx-auto group dark:bg-black bg-white dark:border-white border-black border-2 rounded-lg"
      >
        ...
        <div className="relative w-full h-full overflow-hidden rounded-lg">
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <span
              key={i}
              className={`absolute inset-0 rounded-lg border-solid border-[3px] border-gradient-to-b from-transparent  mix-blend-overlay filter ${
