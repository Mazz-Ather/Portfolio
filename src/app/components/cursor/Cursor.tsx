...
const Cursor = () => {
  ...
  return (
    <div className="cursor pointer-events-none fixed left-0 top-0 z-50 flex h-5 w-5 items-center justify-center rounded-full bg-white text-lg font-bold text-gray-400">
      {cursorVariant}
    </div>
  );
};
